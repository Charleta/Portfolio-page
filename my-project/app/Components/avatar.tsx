  ...
  return (
    <>
      ...
      <ContainerPage>
        ...
        <h1 className="text-2xl text-center md:text-left md:text-5xl md:mt-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:gap-10 mt-10">
          ...
          {/* Texto */}
          <div className="mt-6 md:mt-0 max-w-xl text-md p-5 text-white text-center md:text-left">
            <p className="mb-4">
